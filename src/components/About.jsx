        ...
        <div className=" py-16 rounded-md bg-cyan-800 flex flex-col justify-center items-center w-4/6">
          ...
          <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-3">
            <div className="sm:text-right text-3xl font-bold">
              <p>
                Hi. I'm Hiren Khanchandani, nice to meet you. Please take a
                look around.
              </p>
            </div>
            <div>
              <p>
                ...
                practices. In addition to web development, I also possess extensive knowledge in Azure & AWS Cloud.
              </p>
            </div>
          </div>
        </div>
